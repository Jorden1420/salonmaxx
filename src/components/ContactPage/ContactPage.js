    ...
    <div className="contact-page-container" ref={contactRef}>
      ...
      <div className="fluid-container">
        <div
          ...
          style={{ backgroundColor: "#611144" }}
        >
          <div className="container">
            <div className="row">
              <div className="col-lg-3 m-3">
                <div className="background-change p-3">
                  <h3 style={{ color: "#DB0159" }}>Contact Information</h3>
              ...
              <div className="col-lg-3 m-3">
                <div className="background-change p-3">
                  <h3 style={{ color: "#DB0159" }}>Business Hours</h3>
                  ...
                  <div className="social-media-container pt-3">
                    <h3 style={{ color: "#DB0159" }}>Social Media</h3>{" "}
